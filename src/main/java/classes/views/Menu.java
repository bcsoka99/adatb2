...
public class Menu extends HorizontalLayout {
    ...
    public Menu(){
        ...
        MenuItem jegyfoglalas = menu.addItem("jegyfoglalas", event -> UI.getCurrent().navigate("jegyfoglalás"));
        ...
        MenuItem legenpszerubbJaratok = felsorolasokSubMenu.addItem("legenpszerubb", event -> UI.getCurrent().navigate("legnepszerubb"));
